...
void setup()
{
  ...
  //myPort = new Serial(this, Serial.list()[0], 15200); // if you have only ONE serial port active

  // if you know the serial port name
  //myPort = new Serial(this, "COM7:", 112500);        // Windows "COM#:"
  myPort = new Serial(this, "\\\\.\\COM7", 115200); // Windows, COM10 or higher
